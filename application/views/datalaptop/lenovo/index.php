        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <img src="<?= base_url(); ?>assets/dist/img/logo_lenovo.svg" alt="lenovo logo" width="200">

                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">LENOVO</a></li>
    ...
    <div class="content">
        ...
        <div class="table-responsive">
            <table class="table table-striped" id="this-table">
                <tr style="background-color: #E22319; color: white;">
                    <th>NO</th>
                    <th>PICTURE</th>
                    <th>TITLE</th>
                    <th>PRICE</th>
                ...
                <?php foreach ($laptops as $laptop) : ?>
                    ...
                    <tr>
                        <th scope="row"><?= $i; ?></th>
                        <td><img src="<?= base_url('assets/img/lenovo/') . $laptop['picture']; ?>" alt="<?= $laptop['picture']; ?>" width="100"></td>
                        <td id="title"><?= $laptop['title']; ?></td>
                        <td><?= $laptop['price']; ?></td>
                        <td><?= $laptop['cpu']; ?></td>
                        <td><a href="<?= base_url('Lenovo/detail/') . $laptop['id']; ?>">
                                <div class="btn btn-success btn-sm">
                                    <i class="fa fa-eye"></i>
                                </div>
                        </td>
                        <td>
                            <a href="<?= base_url('Lenovo/edit/') . $laptop['id']; ?>">
                                <div class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil-alt"></i>
                                </div>
                        </td>
                        <td>
                            <a class="btn-delete" href="<?= base_url('Lenovo/delete/') . $laptop['id']; ?>">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('Lenovo/add') ?>" method="post" enctype="multipart/form-data" autocomplete="off">

                            <div class="form-group">
                                <label>Brand</label>
                                <input type="text" name="merk" class="form-control" readonly value="Lenovo">
                            </div>
                            <div class="form-group">
                                <label>Title</label>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <img src="<?= base_url('assets/img/lenovo/default_lenovo.jpg') ?>" class="img-thumbnail img-preview">
                                    </div>
