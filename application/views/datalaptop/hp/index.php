        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <img src="<?= base_url(); ?>assets/dist/img/logo_hp.svg" alt="hp logo" width="100">
        ...
        <div class="table-responsive">
            <table class="table table-striped" id="this-table">
                ...
                <?php foreach ($laptops as $laptop) : ?>
                    ...
                    <tr>
                        <th scope="row"><?= $i; ?></th>
                        <td><img src="<?= base_url('assets/img/hp/') . $laptop['picture']; ?>" alt="<?= $laptop['picture']; ?>" width="100"></td>
                        <td id="title"><?= $laptop['title']; ?></td>
                        <td><?= $laptop['price']; ?></td>
                        <td><?= $laptop['cpu']; ?></td>
                        <td><a href="<?= base_url('Hp/detail/') . $laptop['id']; ?>">
                                <div class="btn btn-success btn-sm">
                                    <i class="fa fa-eye"></i>
                                </div>
                        </td>
                        <td>
                            <a href="<?= base_url('Hp/edit/') . $laptop['id']; ?>">
                                <div class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil-alt"></i>
                                </div>
                        </td>
                        <td>
                            <a class="btn-delete" href="<?= base_url('Hp/delete/') . $laptop['id']; ?>">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('Hp/add') ?>" method="post" enctype="multipart/form-data" autocomplete="off">

                            <div class="form-group">
                                <label>Brand</label>
                                <input type="text" name="merk" class="form-control" readonly value="Hp">
                            </div>
                            <div class="form-group">
                                <label>Title</label>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <img src="<?= base_url('assets/img/hp/default_hp.jpg') ?>" class="img-thumbnail img-preview">
                                    </div>
